...
#source-code #core #configuration #constants
...
**Used By**: [[source/core/mediapipe-utils-py|mediapipe_utils.py]]

#### `MODELS_DIR`
**Type**: Path string  
**Value**: `{DATA_OUTPUT_DIR}/models`  
**Purpose**: ONNX model storage  
**Used By**: [[source/api/main-py#lifespan|main.py lifespan()]]

#### `TRAIN_CHECKPOINTS_DIR`
**Type**: Path string  
**Value**: `{DATA_OUTPUT_DIR}/checkpoints`  
**Purpose**: PyTorch training checkpoints  
**Used By**: [[source/modelling/train-py|train.py]]
...
**Used By**: [[source/api/live-processing-py#Thread Pool|live_processing.py]]
...
### Using Enums
```python
from core.constants import SplitType, DatasetType
...
**Used By**:
- [[source/api/main-py|main.py]] - MODELS_DIR
- [[source/api/live-processing-py|live_processing.py]] - MAX_WORKERS
- [[source/api/websocket-py|websocket.py]] - SEQ_LEN
- [[source/core/mediapipe-utils-py|mediapipe_utils.py]] - LANDMARKERS_DIR
- [[source/modelling/model-py|model.py]] - DEVICE, SEQ_LEN, FEAT_DIM
- All data modules - Dataset paths and constants

**Conceptual**:
- [[deployment/environment-configuration|Environment Configuration]]
- [[data/dataset-overview|Dataset Overview]]

---

**File Location**: `../../../src/core/constants.py`
