...
**Parameters**:
- `mp_processor` ([[source/core/mediapipe-utils-py#LandmarkerProcessor|LandmarkerProcessor]]): MediaPipe processor
...
**Calls**:
- [[source/core/mediapipe-utils-py#LandmarkerProcessor.extract_frame_keypoints|mp_processor.extract_frame_keypoints()]]
...
**Configuration**: [[source/core/constants-py#MAX_WORKERS|MAX_WORKERS]] = 4

**Used By**: [[#get_frame_kps|get_frame_kps()]]

## Related Documentation

- [[source/api/websocket-py|websocket.py]] - Main consumer
